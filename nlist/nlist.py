...
from utils import cu_pbc_dist2, cu_unravel_index_f, cu_ravel_index_f_pbc
...
class nlist(object):
    def __init__(self, system, r_cut, r_buff=0.5, cell_guess=50, n_guess=150):
        self.system = system
        ...
        with cuda.gpus[self.gpu]:
            while True:
                ...
                cu_nlist[self.bpg, self.tpb](self.system.d_x, self.d_last_x, self.system.d_box, self.r_cut2,
                                             self.d_cell_map, self.d_cell_list, self.d_cell_counts, self.d_cells,
